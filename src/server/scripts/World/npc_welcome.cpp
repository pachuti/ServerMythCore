...
public:
	...
	{
    		pPlayer->ADD_GOSSIP_ITEM( 1, " -  Carta de Bienvenida" , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 1);
    		pPlayer->ADD_GOSSIP_ITEM( 0, " -  Canal General"     , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 2);
    		pPlayer->ADD_GOSSIP_ITEM( 5, " -  Capacidad del server"    , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 3);
    		pPlayer->ADD_GOSSIP_ITEM( 3, " -  Reglas"              , GOSSIP_SENDER_MAIN, GOSSIP_ACTION_INFO_DEF + 4);
